...
import { motion, MotionProps, type MotionConfigProps as AnimationProps } from "motion/react";
...
>(({ children, className, ...props }, ref) => {
  return (
    ...
    >
      <span
        className="relative inline-flex items-center justify-center text-sm uppercase tracking-wide leading-none text-current"
        style={{
          maskImage:
