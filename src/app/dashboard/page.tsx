      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="bg-white border-gray-200">
              <CardHeader>
                <CardTitle className="text-xl font-bold text-black">Recent Campaigns</CardTitle>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-black">Summer Sale Campaign</h3>
                        <p className="text-sm text-gray-600">Active • 2 days ago</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-black">Product Launch</h3>
                        <p className="text-sm text-gray-600">Active • 1 week ago</p>
                      </div>
                    </div>
                    <div className="text-right">
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-black">Brand Awareness</h3>
                        <p className="text-sm text-gray-600">Active • 2 weeks ago</p>
                      </div>
                    </div>
                    <div className="text-right">
          ...
          <div>
            ...
            <Card className="bg-white border-gray-200 mt-6">
              <CardHeader>
                <CardTitle className="text-xl font-bold text-black">AI Insights</CardTitle>
                <CardDescription className="text-gray-600">
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  <h4 className="font-semibold text-black mb-2">Optimize Timing</h4>
                  <p className="text-sm text-gray-600">
                    Your campaigns perform 23% better when sent between 2-4 PM. Consider adjusting your schedule.
                  </p>
                </div>
                <div className="p-4 bg-green-50 rounded-lg">
                  <h4 className="font-semibold text-black mb-2">Audience Growth</h4>
                  <p className="text-sm text-gray-600">
                    Your audience has grown 15% this month. Great job on engagement!
                  </p>
                </div>
              </CardContent>
            </Card>
