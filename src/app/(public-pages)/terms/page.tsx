            ...
            <Card className="bg-white border-gray-200 shadow-lg rounded-xl">
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  By accessing and using Marketing AI&apos;s services, you
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Permission is granted to temporarily download one copy of the
                   materials (information or software) on Marketing AI&apos;s website
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                   The materials on Marketing AI&apos;s website are provided on an &apos;as
                   is&apos; basis. Marketing AI makes no warranties, expressed or
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                   In no event shall Marketing AI or its suppliers be liable for
                  any damages (including, without limitation, damages for loss
                  of data or profit, or due to business interruption) arising
                  out of the use or inability to use the materials on Marketing
                   AI&apos;s website, even if Marketing AI or a Marketing AI
